...
<head>
  ...
  <title>Agregar hábito - StoneBook</title>
  ...
  <main id="main" class="main">
    ...
    <div class="card" style="background-color: #fff;">
        <div class="card-body">
            ...
            <form class="row g-3" action="habitos_be_insertar.php" method="post">
                    <div class="col-md-8">
                        <label class="form-label">Nombre de hábito</label>
                        <input required name="nombreHabi" type="text" autocomplete="off" maxlength="100" class="form-control" style="border-color: #05a649">
                        <br>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Tipo de hábito</label>
                        <select required name="tipoHabi" class="form-select" style="border-color: #05a649">
                            <option selected disabled value="">Elige si el hábito es bueno o malo</option>
                            <option value="true">Buen hábito</option>
                            <option value="false">Mal hábito</option>
                        </select>
                    </div>
                    <div class="col-md-12">
                        <label class="col-sm-2 col-form-label">Notas</label>
                        <textarea name="notas" class="form-control" maxlength="500" style="height: 100px"></textarea>
                    </div>
                    <br><br><br><br><br>
