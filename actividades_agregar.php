...
<head>
  ...
  <title>Agregar actividad - StoneBook</title>
  ...
  <main id="main" class="main">
    ...
    <div class="card" style="background-color: #fff;">
        <div class="card-body">
            ...
            <form class="row g-3" action="actividades_be_insertar.php" method="post">
                    <div class="col-md-12">
                        <label class="form-label">Nombre de actividad</label>
                        <input required name="nombreActi" type="text" autocomplete="off" maxlength="100" class="form-control" style="border-color: #05a649">
                        <br>
                    </div>
                    <div class="col-md-12">
                        <label class="col-sm-2 col-form-label">Descripción</label>
                        <textarea name="descripcion" class="form-control" maxlength="500" style="height: 100px"></textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Etiquetas</label> 
                        <select name="etiquetas" class="form-select" style="background-color: #fff">
                            <option value="0">N/A</option>

                            <?php while($row = $etiquetasUsuario->fetch_assoc()){ ?>
                                <option value="<?php echo $row["idEtiq"]; ?>"><?php echo $row["e_nombre"] ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Fecha de vencimiento</label>
                        <input name="vencimiento" type="datetime-local" min="2000-01-01T00:00" max="9999-12-31T23:59" class="form-control">
                    </div>
                    <div class="col-md-6">
