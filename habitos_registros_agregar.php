...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <span>Agregar registro de hábito: <?php echo $habiActual["h_nombre"]; ?></span>
      <br>
      <br>
    </div><!-- End Page Title -->
    ...
    <div class="card" style="background-color: #fff;">
        <div class="card-body">
            <br>
            <!-- Multi Columns Form -->
            <form class="row g-3" action="habitos_registros_be_insertar.php?idHabi=<?php echo $idHabi; ?>" method="post">
                    <div class="col-md-3">
                        <label class="form-label">¿Cuándo pasó?</label>
                        <input required name="fecha" type="datetime-local" min="<?php echo $fechaMinima["fechaDatetime"]; ?>" max="9999-12-31T23:59" class="form-control" style="border-color: #05a649">
                    </div>
                    <div class="col-md-9">
                        <label class="form-label">Notas</label>
                        <textarea name="notas" class="form-control" maxlength="500" style="height: 38px"></textarea>
                    </div>
                    <br><br><br><br><br>
