...
<head>
  ...
  <title>Editar entrada de diario - StoneBook</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <span>Editar entrada de diario</span>
      <br>
      <br>
    </div><!-- End Page Title -->
    ...
    <div class="card" style="background-color: #fff;">
        <div class="card-body">
            ...
            <?php
                $datosEntradaActual = $instCon->getDatosEntradaDiario( $idEntrActual );
                $entradaActual = $datosEntradaActual->fetch_assoc();
            ?>
            
            <form class="row g-3" action="diario_be_actualizar.php?idEntrada=<?php echo $idEntrActual; ?>" method="post">      
              <div class="col-md-12">
                <label class="col-sm-12 col-form-label">Entrada</label>
                <textarea required name="cuerpo" class="form-control" style="border-color: #05a649; height: 100px"><?php echo $entradaActual["d_cuerpo"] ?></textarea>
              </div>
              <div class="col-md-12">
                ...
                <select name="emocion" class="form-select">
                  ...
                  <?php while($emocion = $emociones->fetch_assoc()) { ?>
                      <option value="<?php echo $emocion["idEmoc"]; ?>"    <?php if($emocion["idEmoc"] == $entradaActual["idEmoc"]){echo "selected";} ?>    ><?php echo $emocion["em_nombre"] ?></option>
                  <?php } ?>
                </select>
              </div>
              <br><br><br><br><br>
